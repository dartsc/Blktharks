# **This version of ublobm(credits to ublobm) is a version to mostly bypass the strict content policies of the script itself:**
...
2. **Modifying Advanced Settings**  
   ...
   - Change it from `unset` to:  
     `https://raw.githubusercontent.com/dartsc/Blktharks/refs/heads/main/blob.js`
